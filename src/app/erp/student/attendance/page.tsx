...
export default async function StudentAttendancePage() {
  ...
  if (!data) {
    return (
      <div className="max-w-7xl mx-auto p-8 text-center text-slate-600">
        Student profile not linked. Please contact your school administrator.
      </div>
    )
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
      <div className="mb-6">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">My Attendance Record</h1>
        <p className="text-sm text-slate-600">View your personal attendance history and percentage.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
          ...
          <span className="text-xs text-slate-500 font-mono">Admission: {admissionNumber}</span>
        </div>
