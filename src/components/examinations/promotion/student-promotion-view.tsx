...
export function StudentPromotionView({ activeHistory, promotionHistory }: Props) {
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
        <div className="flex justify-between items-center border-b border-slate-200 pb-3">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Current Academic Enrollment</h2>
            <p className="text-xs text-slate-500">Authoritative active session registration</p>
          </div>
