...
- Name: auth-verification.spec.ts >> Phase 2 Auth & Portal Access Verification >> 4. Principal Authorization
- Location: e2e\auth-verification.spec.ts:43:7
...
Expected pattern: /\/erp\/principal/
...
- text: Email
- textbox "Enter your email": principal@roshanischool.com
- text: Password
