...
- Name: auth-verification.spec.ts >> Phase 2 Auth & Portal Access Verification >> 8. Student Authorization
- Location: e2e\auth-verification.spec.ts:98:7
...
- text: Email
- textbox "Enter your email": student@roshanischool.com
- text: Password
