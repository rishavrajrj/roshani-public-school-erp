...
- Name: auth-verification.spec.ts >> Phase 2 Auth & Portal Access Verification >> 7. Parent Authorization
- Location: e2e\auth-verification.spec.ts:83:7
...
- text: Email
- textbox "Enter your email": parent@roshanischool.com
- text: Password
