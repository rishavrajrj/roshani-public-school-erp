...
- Name: auth-verification.spec.ts >> Phase 2 Auth & Portal Access Verification >> 11. Disabled User
- Location: e2e\auth-verification.spec.ts:138:7
...
Expected pattern: /\/erp\/unauthorized/
...
- text: Email
- textbox "Enter your email": disabled@roshanischool.com
- text: Password
