...
- Name: auth-verification.spec.ts >> Phase 2 Auth & Portal Access Verification >> 9. Super Admin Authorization
- Location: e2e\auth-verification.spec.ts:113:7
...
- text: Email
- textbox "Enter your email": superadmin@roshanischool.com
- text: Password
